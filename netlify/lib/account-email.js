...
async function sendAccountInvite({ email, name, username, token }) {
  ...
  try {
    ...
    console.warn('[account-invite-email]', error.message);
    return { sent: false, error: 'Não foi possível enviar o convite' };
  }
}

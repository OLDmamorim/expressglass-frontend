...
const { ensureSingleFirstOfDay } = require('./lib/first-of-day-invariant');
...
exports.handler = async (event) => {
  ...
  try {
    await ensureSingleFirstOfDay(pool);
  } catch(migErr) {
    console.warn('Migration single first_of_day warning:', migErr.message);
  }
